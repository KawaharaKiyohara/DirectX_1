...
void Effect::Load(const char* filePath)
{
	...
	g_pd3dDevice->CreateInputLayout(inputLayoutDesc, sizeof(inputLayoutDesc)/sizeof(inputLayoutDesc[0]), m_vsBlobOut->GetBufferPointer(), m_vsBlobOut->GetBufferSize(), &m_inputLayout);
}
