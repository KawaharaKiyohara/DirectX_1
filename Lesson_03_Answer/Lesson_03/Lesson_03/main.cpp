...
///////////////////////////////////////////////////////////////////
//ここから四角形ポリゴン描画関係の変数など。
///////////////////////////////////////////////////////////////////
ID3D11Buffer* g_vertexBuffer = NULL;		//頂点バッファ。
ID3D11Buffer* g_indexBuffer = NULL;			//インデックスバッファ。
...
void InitVertexBuffer()
{
	...
	SVertex vertex[8] = {
		...
		{ 0.0f, -0.75f, 0.0f, 1.0f },	//頂点５
		{ 0.75f,  0.0f, 0.0f, 1.0f },	//頂点６
		{ -0.75f,  0.0f, 0.0f, 1.0f },	//頂点７
		{ 0.0f,  0.75f, 0.0f, 1.0f },	//頂点８
...
void GameUpdate()
{
	...
	//プリミティブのトポロジーは
	//トライアングルストリップを設定する。(詳しくはLesson_3で解説を行う。)
