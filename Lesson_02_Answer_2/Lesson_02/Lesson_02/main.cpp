...
ID3D11Buffer* g_vertexBuffer2 = NULL;		//頂点バッファ。
...
void InitTrianglePolygon2()
{
	//3頂点を定義する。これが頂点座標
	SVertex vertex[3] = {
		{ 0.5f,  0.25f, 0.0f, 1.0f },	//頂点１
		{ 0.0f,  -0.75f, 0.0f, 1.0f },	//頂点２
		{ -0.5f, 0.25f, 0.0f, 1.0f },	//頂点３
	};
	//上で定義した頂点を使用して頂点バッファを作成する。
	//頂点バッファを作成するためにはD3D11_BUFFER_DESCとD3D11_SUBRESOURCE_DATAを設定する必要がある。
	D3D11_BUFFER_DESC bd;
	...
	//頂点バッファの作成。
	g_pd3dDevice->CreateBuffer(&bd, &InitData, &g_vertexBuffer2);
}
///////////////////////////////////////////////////////////////////
// 毎フレーム呼ばれるゲームの更新処理。
///////////////////////////////////////////////////////////////////
