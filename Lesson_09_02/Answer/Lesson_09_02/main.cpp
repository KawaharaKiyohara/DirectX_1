...
int WINAPI wWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPWSTR lpCmdLine, int nCmdShow)
{
	...
	g_coin[0]->m_position.x = 300.0f;
	g_coin[0]->m_position.y = -200.0f;

	g_coin[1]->m_position.x = 220.0f;
	g_coin[1]->m_position.y = -200.0f;

	g_coin[2]->m_position.x = 140.0f;
	g_coin[2]->m_position.y = -200.0f;

	g_coin[3]->m_position.x = 60.0f;
	g_coin[3]->m_position.y = -200.0f;

	g_coin[4]->m_position.x = -20.0f;
	g_coin[4]->m_position.y = -200.0f;
