...
Sprite g_hpBarSprite;
Sprite g_hpSprite;

Sprite g_mpBarSprite;
Sprite g_mpSprite;
...
void GameUpdate()
{
	...
	//HPバーを表示する。
	const CVector3 hpPos = { -592.95f, 320.0f - 3, 1.0f };
	const CVector3 hpBarPos = { -600.0f, 320.0f - 3, 1.0f };
	g_hpBarSprite.Update(hpBarPos, CQuaternion::Identity(), CVector3::One(), {0.0f, 0.5f});
	g_hpSprite.Update(hpPos, CQuaternion::Identity(), CVector3::One(), { 0.0f, 0.5f });
	g_hpBarSprite.Draw();
	g_hpSprite.Draw();

	//MPバーを表示する。
	const CVector3 mpPos = { -592.95f, 278.0f - 3, 1.0f };
	const CVector3 mpBarPos = { -600.0f, 278.0f - 3, 1.0f };
	g_mpBarSprite.Update(mpBarPos, CQuaternion::Identity(), CVector3::One(), { 0.0f, 0.5f });
	g_mpSprite.Update(mpPos, CQuaternion::Identity(), CVector3::One(), { 0.0f, 0.5f });
	g_mpBarSprite.Draw();
	g_mpSprite.Draw();
...
int WINAPI wWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPWSTR lpCmdLine, int nCmdShow)
{
	...
	g_hpBarSprite.Init(L"Resource/sprite/hpmp_bar.dds", 350, 45);
	g_hpSprite.Init(L"Resource/sprite/hp.dds", 130.0f, 26.0f);
	g_mpBarSprite.Init(L"Resource/sprite/hpmp_bar.dds", 350, 45);
	g_mpSprite.Init(L"Resource/sprite/mp.dds", 130.0f, 26.0f);
