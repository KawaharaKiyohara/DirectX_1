...
int WINAPI wWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPWSTR lpCmdLine, int nCmdShow)
{
	...
	g_coin[1]->m_position.x = -300.0f;
	g_coin[1]->m_position.y = 200.0f;

	g_coin[2]->m_position.x = 220.0f;
	g_coin[2]->m_position.y = 100.0f;

	g_coin[3]->m_position.x = -120.0f;
	g_coin[3]->m_position.y = 400.0f;

	g_coin[4]->m_position.x = 0.0f;
	g_coin[4]->m_position.y = 110.0f;
